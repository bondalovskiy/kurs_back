...
import com.bndlvsk.spotapp.entity.*;
import com.bndlvsk.spotapp.exception.UserNotFoundException;
import com.bndlvsk.spotapp.model.spotify.Genre;
import com.bndlvsk.spotapp.model.spotify.Artist;
import com.bndlvsk.spotapp.model.spotify.Track;
import com.bndlvsk.spotapp.repository.ArtistRepository;
import com.bndlvsk.spotapp.repository.GenreRepository;
import com.bndlvsk.spotapp.repository.TrackRepository;
            ...
            Map<String, Integer> tracks = entry.getKey()
                    ...
                    .collect(Collectors
                            .toMap(item -> {
                                ...
                                return (artists != null && !artists.isEmpty() ? artists.get(0).getName() : null) + "_" + item.getName();
                                //not null needed
