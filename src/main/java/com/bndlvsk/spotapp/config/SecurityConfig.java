...
import com.bndlvsk.spotapp.jwt.JwtAuthenticationFilter;
import com.bndlvsk.spotapp.jwt.JwtProvider;
import com.bndlvsk.spotapp.oauth2.*;
...
public class SecurityConfig {
    ...
    @Value("${spotapp.client.url}")
    private String CLIENT_URL;

    @Value("${spotapp.api.admin-email}")
    private String ADMIN_EMAIL;

    @Value("${jwt.provider.secret}")
    private String SPOTAPP_SECRET;
    ...
    public JwtProvider jwtProvider() {
        return new JwtProvider(SPOTAPP_SECRET);
    }
    ...
    public OAuth2SuccessHandler oAuth2SuccessHandler(SpotifyTokenRepository spotifyTokenRepository,
        ...
        return new OAuth2SuccessHandler(spotifyTokenRepository, httpCookieOAuth2AuthorizationRequestRepository, libraryDataSyncService, jwtProvider, URI.create(CLIENT_URL));
    }
